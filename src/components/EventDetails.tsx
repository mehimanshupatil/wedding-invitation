...
const EventCard = ({
	...
	>
		...
		<div className="space-y-4 text-stone-500 mb-8 font-medium tracking-wide text-xs uppercase">
		...
		<section className="py-16 relative z-10">
			<div className="max-w-6xl mx-auto px-6">
				...
				>
					...
					<h2 className="font-serif text-5xl md:text-6xl text mt-6 font-light">
						The Events
					</h2>
				</motion.div>
