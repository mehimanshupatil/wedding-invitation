      ...
      {isVisible && (
        ...
        >
          ...
          >
            {/* Content */}
            <div
              className="w-48 h-48 border border-primary/20 rounded-full bg-secondary absolute top-1/2 left-full -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center z-10"
            >
