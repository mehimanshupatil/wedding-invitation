...
const Hero = () => {
	return (
		<section className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden px-4 py-10">
			<div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto w-full">
				...
				>
					<span className="text-primary uppercase tracking-[0.4em] text-xs font-medium mb-6">
						Save the Date
					</span>

					<h1 className="font-serif text-6xl md:text-8xl lg:text-9xl text-text mb-6 leading-[0.9]">
						Shremal <br />
						<span className="italic text-primary ml-0 md:ml-12">&</span>{" "}
						Himanshu
					</h1>
