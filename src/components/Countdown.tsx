...
const Countdown = () => {
	const calculateTimeLeft = () => {
		const difference = +new Date("2026-02-06T00:00:00") - Date.now();
		let timeLeft = {
			days: 0,
			hours: 0,
			minutes: 0,
	...
	return (
		<section className="py-20 bg-secondary relative z-10">
			...
			>
				<p className="text-stone-400 uppercase tracking-[0.3em] text-xs mb-12">
					Countdown to Forever
				</p>

				<div className="flex flex-wrap justify-center gap-y-8">
					<TimeUnit value={timeLeft.days} label="Days" />
					<div className="hidden md:block text-2xl text-primary/30 mt-4 self-start">
						/
					</div>
